...
function parseAction(value) {
	...
	if (action.kind === "import-source" && typeof action.provider === "string" && typeof action.sourceKind === "string" && typeof action.key === "string" && (action.connector === void 0 || typeof action.connector === "string")) return action;
	if (action.kind === "create-draft" && isStageId(action.stage) && typeof action.title === "string" && (action.key === void 0 || typeof action.key === "string") && stringArray(action.basedOn) && (action.sourceUids === void 0 || stringArray(action.sourceUids))) return action;
}
