...
function parseAction(value) {
	...
	if (action.kind === "update-work-item-settings" && typeof action.workItemUid === "string" && stringArray(action.repositoryScope) && stringArray(action.developmentTargets) && (action.developmentTargetDetails === void 0 || stringRecord(action.developmentTargetDetails)) && (action.openSpec === void 0 || typeof action.openSpec === "object" && action.openSpec !== null)) return action;
	if (action.kind === "update-stage-applicability" && typeof action.workItemUid === "string" && isStageId(action.stage) && (action.status === "applicable" || action.status === "not-applicable") && (action.reason === void 0 || typeof action.reason === "string")) return action;
	...
	if (action.kind === "initialize-project-repository" && typeof action.source === "string" && typeof action.branch === "string") return action;
	...
	if (action.kind === "update-project-collaboration" && typeof action.remote === "string" && typeof action.baseBranch === "string" && (action.syncStrategy === "ff-only" || action.syncStrategy === "manual") && (action.commitScope === "sdd" || action.commitScope === "workspace")) return action;
	if (action.kind === "project-git-fetch" || action.kind === "project-git-sync" || action.kind === "project-git-push") return action;
	if (action.kind === "project-git-commit" && typeof action.message === "string" && action.message.trim() !== "") return action;
	if (action.kind === "resolve-artifact-key-conflict" && typeof action.artifactUid === "string") return action;
	...
	if (action.kind === "development-install-openspec" && typeof action.workItemUid === "string") return action;
	if (action.kind === "development-initialize-openspec" && typeof action.artifactUid === "string" && typeof action.tools === "string") return action;
	if (action.kind === "development-fork-openspec-schema" && typeof action.artifactUid === "string" && typeof action.schema === "string") return action;
	if (action.kind === "development-open-openspec-schema" && typeof action.artifactUid === "string" && typeof action.schema === "string") return action;
	if (action.kind === "development-inspect-openspec-templates" && typeof action.artifactUid === "string" && typeof action.schema === "string") return action;
	if (action.kind === "development-create-openspec-change" && typeof action.artifactUid === "string" && typeof action.changeId === "string" && typeof action.schema === "string") return action;
	if (action.kind === "openspec-update-settings" && typeof action.workItemUid === "string" && typeof action.enabled === "boolean" && (action.schema === void 0 || typeof action.schema === "string")) return action;
	if (action.kind === "openspec-initialize" && typeof action.workItemUid === "string" && typeof action.tools === "string") return action;
	if ((action.kind === "openspec-fork-schema" || action.kind === "openspec-create-change") && typeof action.workItemUid === "string" && typeof action.schema === "string" && (action.kind === "openspec-fork-schema" || typeof action.changeId === "string")) return action;
	if (action.kind === "openspec-read-file" && typeof action.workItemUid === "string" && typeof action.path === "string") return action;
	if (action.kind === "openspec-write-file" && typeof action.workItemUid === "string" && typeof action.path === "string" && typeof action.content === "string") return action;
	if ((action.kind === "openspec-validate" || action.kind === "openspec-open-path") && typeof action.workItemUid === "string" && (action.kind === "openspec-validate" || typeof action.path === "string")) return action;
	if (action.kind === "development-skip-test" && typeof action.artifactUid === "string" && typeof action.repositoryId === "string" && typeof action.reason === "string" && action.reason.trim() !== "") return action;
	...
	if (action.kind === "close-delivery" && typeof action.workItemUid === "string" && (action.featureUid === void 0 || typeof action.featureUid === "string") && typeof action.featureName === "string" && action.featureName.trim() !== "" && (action.changeType === "created" || action.changeType === "updated" || action.changeType === "deprecated") && typeof action.summary === "string" && action.summary.trim() !== "") return action;
	if (action.kind === "read-product-file" && typeof action.path === "string") return action;
	if ((action.kind === "import-source" || action.kind === "preview-source-import") && typeof action.provider === "string" && typeof action.sourceKind === "string" && typeof action.key === "string" && (action.connector === void 0 || typeof action.connector === "string") && (action.attachToWorkItemUid === void 0 || typeof action.attachToWorkItemUid === "string") && (action.input === void 0 || typeof action.input === "object" && action.input !== null && !Array.isArray(action.input))) return action;
	if (action.kind === "read-source-import-detail" && typeof action.previewUid === "string" && typeof action.identity === "string") return action;
