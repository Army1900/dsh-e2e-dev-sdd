...
`;
		async function call(action) {
			const timeout = action.kind === "development-install-openspec" ? 33e4 : action.kind === "development-initialize-openspec" ? 21e4 : action.kind === "add-project-repository" || action.kind === "inspect-project-repository" || action.kind === "initialize-project-repository" || action.kind === "update-project-repository-branch" ? 75e3 : 2e4;
