...
`;
		async function call(action) {
			const timeout = action.kind === "development-install-openspec" ? 33e4 : action.kind === "development-initialize-openspec" ? 21e4 : action.kind === "development-fork-openspec-schema" || action.kind === "development-create-openspec-change" || action.kind === "development-inspect-openspec-templates" ? 75e3 : action.kind === "add-project-repository" || action.kind === "inspect-project-repository" || action.kind === "initialize-project-repository" || action.kind === "update-project-repository-branch" ? 75e3 : 2e4;
